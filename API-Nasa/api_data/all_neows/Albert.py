...
albert_all_data = dict()


links = {'self': 'http://api.nasa.gov/neo/rest/v1/neo/2000719?api_key=NgtvBLp13upL4FK2z6qyWSRJNcJ3U1w4fJcokZmi'}
...
estimated_diameter = {
    "feet": {'estimated_diameter_min': 6645.6892174112, 'estimated_diameter_max': 14860.2128474689}, 
    "miles": {'estimated_diameter_min': 1.2586528312, 'estimated_diameter_max': 2.8144332906}, 
    "meters": {'estimated_diameter_min': 2025.6060086475, 'estimated_diameter_max': 4529.3927309679}, 
    "kilometers": {'estimated_diameter_min': 2.0256060086, 'estimated_diameter_max': 4.529392731}, 
...
orbital_data = {
    ...
    "orbit_uncertainty": "0", 
    "minimum_orbit_intersection": ".201404", 
    "jupiter_tisserand_invariant": "3.141", 
    "epoch_osculation": "2460400.5", 
    "eccentricity": ".5468964908518698", 
    "semi_major_axis": "2.636118920488568", 
    "inclination": "11.57577814230827", 
    "ascending_node_longitude": "183.8547427457693", 
    "orbital_period": "1563.312945561177", 
    "perihelion_distance": "1.194434733405151", 
    "perihelion_argument": "156.2221413583312", 
    "aphelion_distance": "4.077803107571985", 
    "perihelion_time": "2459955.944856209393", 
    "mean_anomaly": "102.3722423709411", 
    "mean_motion": ".2302801886354059", 
    "equinox": "J2000", 
    "orbit_class": {
...
albert_all_data["links"] = links
albert_all_data["id_code"] = id_code
albert_all_data["neo_reference_id"] = neo_reference_id
albert_all_data["name"] = name
albert_all_data["name_limited"] = name_limited
albert_all_data["designation"] = designation
albert_all_data["nasa_jpl_url"] = nasa_jpl_url
albert_all_data["absolute_magnitude_h"] = absolute_magnitude_h
albert_all_data["estimated_diameter"] = estimated_diameter
albert_all_data["is_potentially_hazardous_asteroid"] = is_potentially_hazardous_asteroid
albert_all_data["close_approach_data"] = close_approach_data
albert_all_data["orbital_data"] = orbital_data
albert_all_data["is_sentry_object"] = is_sentry_object
