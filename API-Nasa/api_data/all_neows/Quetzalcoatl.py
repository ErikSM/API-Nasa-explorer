...
quetzalcoatl_all_data = dict()


links = {'self': 'http://api.nasa.gov/neo/rest/v1/neo/2001915?api_key=NgtvBLp13upL4FK2z6qyWSRJNcJ3U1w4fJcokZmi'}
...
estimated_diameter = {
    "feet": {'estimated_diameter_min': 1838.8234258117, 'estimated_diameter_max': 4111.7341787341}, 
    "miles": {'estimated_diameter_min': 0.3482618936, 'estimated_diameter_max': 0.778737268}, 
    "meters": {'estimated_diameter_min': 560.4733622523, 'estimated_diameter_max': 1253.2565375739}, 
    "kilometers": {'estimated_diameter_min': 0.5604733623, 'estimated_diameter_max': 1.2532565376}, 
...
orbital_data = {
    ...
    "orbit_uncertainty": "0", 
    "minimum_orbit_intersection": ".109498", 
    "jupiter_tisserand_invariant": "3.122", 
    "epoch_osculation": "2460400.5", 
    "eccentricity": ".5702472402062506", 
    "semi_major_axis": "2.543911909211127", 
    "inclination": "20.4029349424301", 
    "ascending_node_longitude": "162.9365263937609", 
    "orbital_period": "1482.011349467671", 
    "perihelion_distance": "1.093253163655668", 
    "perihelion_argument": "347.7799125283826", 
    "aphelion_distance": "3.994570654766586", 
    "perihelion_time": "2460911.531431062240", 
    "mean_anomaly": "235.8637609297069", 
    "mean_motion": ".2429131194773304", 
    "equinox": "J2000", 
    "orbit_class": {
...
quetzalcoatl_all_data["links"] = links
quetzalcoatl_all_data["id_code"] = id_code
quetzalcoatl_all_data["neo_reference_id"] = neo_reference_id
quetzalcoatl_all_data["name"] = name
quetzalcoatl_all_data["name_limited"] = name_limited
quetzalcoatl_all_data["designation"] = designation
quetzalcoatl_all_data["nasa_jpl_url"] = nasa_jpl_url
quetzalcoatl_all_data["absolute_magnitude_h"] = absolute_magnitude_h
quetzalcoatl_all_data["estimated_diameter"] = estimated_diameter
quetzalcoatl_all_data["is_potentially_hazardous_asteroid"] = is_potentially_hazardous_asteroid
quetzalcoatl_all_data["close_approach_data"] = close_approach_data
quetzalcoatl_all_data["orbital_data"] = orbital_data
quetzalcoatl_all_data["is_sentry_object"] = is_sentry_object
